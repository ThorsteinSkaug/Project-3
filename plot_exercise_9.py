...
df = pd.read_csv('coordinates_rk4.txt', sep=' ', header=None)
t = df[0].to_numpy()
x_rk = df[1].to_numpy()
y_rk = df[2].to_numpy()
z_rk = df[3].to_numpy()
...
df = pd.read_csv('euler2particles_with.txt', sep=' ', header=None)
x_eu2 = df[1].to_numpy()
y_eu2 = df[2].to_numpy()
z_eu2 = df[3].to_numpy()
x2_eu2 = df[4].to_numpy()
y2_eu2 = df[5].to_numpy()
z2_eu2 = df[6].to_numpy()
vx_eu2 = df[7].to_numpy()
vy_eu2 = df[8].to_numpy()
vz_eu2 = df[9].to_numpy()
vx2_eu2 = df[10].to_numpy()
vy2_eu2 = df[11].to_numpy()
vz2_eu2 = df[12].to_numpy()
